...
BLOCKS: list[Bench] = [
    ...
    Bench("goertzel_resonator", "rtl/goertzel/goertzel_resonator.sv", "single-cycle",
          latency="1 clk per sample (II=1)",
          throughput="1 sample per clk (gated by sample_ce)",
          notes="Single multiply-accumulate per enabled cycle."),
    Bench("goertzel_complex_12", "rtl/goertzel/goertzel_complex_12.sv", "single-cycle",
          latency="1 clk per sample (II=1)",
          throughput="1 sample per clk (gated by sample_ce)",
          notes="I/Q pair of resonators."),
    Bench("engeler_goertzel_bank", "rtl/goertzel/engeler_goertzel_bank.sv", "single-cycle",
          latency="1 clk per sample (II=1)",
          throughput="1 sample per clk (gated by sample_ce)",
          notes="Carrier/AM/PM resonator bank."),
    Bench("engeler_observables", "rtl/goertzel/engeler_observables.sv", "composition",
          latency="6 clk to observable_valid (pipeline)",
          throughput="1 sample per clk (gated by sample_ce)",
