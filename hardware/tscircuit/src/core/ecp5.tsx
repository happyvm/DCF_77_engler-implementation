...
export function Ecp5AndConfiguration() {
  return (
    <>
      ...
      <resistor name="RFLASH1" resistance="10k" footprint="0402" {...at("ecp5_flash", "RFLASH1")}
        connections={{ pin1: N.v3v3d, pin2: N.flashMosi }} />
      <resistor name="RFLASH2" resistance="10k" footprint="0402" {...at("ecp5_flash", "RFLASH2")}
        connections={{ pin1: N.v3v3d, pin2: N.flashMiso }} />
      <resistor name="RFLASH3" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RFLASH3")}
        connections={{ pin1: N.v3v3d, pin2: N.flashCsN }} />
      <resistor name="RFLASH4" resistance="1k" footprint="0402" {...at("ecp5_flash", "RFLASH4")}
        connections={{ pin1: N.v3v3d, pin2: N.flashClk }} />
      {/* flash-side unused serial pins tied off */}
      <resistor name="RFLASH5" resistance="10k" footprint="0402" {...at("ecp5_flash", "RFLASH5")}
        connections={{ pin1: N.v3v3d, pin2: ".U_FLASH > .WP_IO2" }} />
      <resistor name="RFLASH6" resistance="10k" footprint="0402" {...at("ecp5_flash", "RFLASH6")}
      ...
      {/* ---------------------------------------------------------------- */}
      <resistor name="RCFG0" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RCFG0")}
        connections={{ pin1: N.v3v3d, pin2: ".U1 > .P10" }} />
      <resistor name="RCFG1" resistance="0" footprint="0402" {...at("ecp5_flash", "RCFG1")}
        connections={{ pin1: ".U1 > .R10", pin2: GND }} />
      <trace from=".U1 > .N10" to={GND} />

      {/* configuration status/control pulls */}
      <resistor name="RPROG" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RPROG")}
        connections={{ pin1: N.v3v3d, pin2: ".U1 > .R9" }} />
      <resistor name="RINIT" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RINIT")}
        connections={{ pin1: N.v3v3d, pin2: ".U1 > .T9" }} />
      <resistor name="RDONE" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RDONE")}
        connections={{ pin1: N.v3v3d, pin2: ".U1 > .P9" }} />

      {/* ---------------------------------------------------------------- */}
      {/* JTAG recovery: mandatory even though normal boot is from flash    */}
      {/* ---------------------------------------------------------------- */}
      <resistor name="RTDI" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RTDI")}
        connections={{ pin1: N.v3v3d, pin2: N.jtagTdi }} />
      <resistor name="RTMS" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RTMS")}
        connections={{ pin1: N.v3v3d, pin2: N.jtagTms }} />
      <resistor name="RTDO" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RTDO")}
        connections={{ pin1: N.v3v3d, pin2: N.jtagTdo }} />
      <resistor name="RTCK" resistance="4.7k" footprint="0402" {...at("ecp5_flash", "RTCK")}
      ...
      <capacitor name="CORE1" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CORE1")}
        connections={{ pin1: N.v1v1core, pin2: GND }} />
      <capacitor name="CORE2" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CORE2")}
        connections={{ pin1: N.v1v1core, pin2: GND }} />
      <capacitor name="CORE3" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CORE3")}
        connections={{ pin1: N.v1v1core, pin2: GND }} />
      <capacitor name="CORE4" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CORE4")}
        connections={{ pin1: N.v1v1core, pin2: GND }} />
      <capacitor name="CORE5" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CORE5")}
        connections={{ pin1: N.v1v1core, pin2: GND }} />
      <capacitor name="CORE6" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CORE6")}
        connections={{ pin1: N.v1v1core, pin2: GND }} />
      ...
      <capacitor name="CAUX1" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CAUX1")}
        connections={{ pin1: N.v2v5aux, pin2: GND }} />
      <capacitor name="CAUX2" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CAUX2")}
        connections={{ pin1: N.v2v5aux, pin2: GND }} />
      ...
      <capacitor name="CVIO8" capacitance="100nF" footprint="0402" {...at("ecp5_flash", "CVIO8")}
